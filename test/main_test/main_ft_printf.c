...
int		main(void)
{
		...
		r = ft_printf(""); // warning linux
				ft_printf("return = %d\n", r);
		ft_printf("== multiple conversions + flags + characters ==\n");

		r = ft_printf("%c%c%c%c%c%c%c%c%c\n", 0, 0, 0, 0, 0, 0, 0, 0, 0);
				ft_printf("return = %d\n", r);
		...
		r = ft_printf("dfzef %s dnzjdj%%%%%%%%%s \n", "xxxxx", "xxxxxxxxx");
				ft_printf("return = %d\n", r);
		r = ft_printf("dfzef %d dnzjdj%%%%%%%%%i \n", 10, 13);
				ft_printf("return = %d\n", r);
		r = ft_printf(
